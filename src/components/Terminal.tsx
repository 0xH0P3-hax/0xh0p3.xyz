...
export const commands: Command = [
  { cmd: "about", desc: "about 0xH0P3", tab: 8 },
  { cmd: "contact", desc: "contact me", tab: 6 },
  { cmd: "activity", desc: "my career experience", tab: 5 },
  { cmd: "vuln", desc: "view vulnerability that I've reported", tab: 5 },
  { cmd: "education", desc: "my education background", tab: 4 },
  { cmd: "blog", desc: "go to my velog blog", tab: 9 },
